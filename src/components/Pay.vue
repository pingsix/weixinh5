<template>
   <div>
      <header>
         ...
         <div class="font17" style="line-height:50px;">借款记录</div>
      </header>
     <div class="weui-tab">
       <div class="weui-navbar">
         <a class="weui-navbar__item weui-bar__item--on" href="#tab1">当前借款</a>
         <a class="weui-navbar__item" href="#tab2">历史借款记录</a>
       </div>
          ...
          <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
              ...
              <div class="weui-cells">
                <div class="weui-cell">
                  ...
                  <div class="weui-cell__ft">2018-11-11-15:11:02</div>
                </div>
                <div class="weui-cell">
                  <div class="weui-cell__bd">
                    <p>借款种类</p>
                  </div>
                  <div class="weui-cell__ft">分期</div>
                </div>
                <div class="weui-cell">
                  <div class="weui-cell__bd">
                    <p>借款期限</p>
                  </div>
                  <div class="weui-cell__ft">3期</div>
                </div>
                <div class="weui-cell">
                  <div class="weui-cell__bd">
                    <p>借款金额</p>
...
.weui-navbar__item{}
.weui-navbar{background-color:#fff;color:#000;border:1px solid #F0F0F0;border-bottom:none;}
